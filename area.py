...
def populate_main_window(frm_main):
    ...
    lbl_radius = Label(frm_main, text="Enter radius(10-99)")

    # Create an integer entry box where the user will enter her age.
    ent_radius = IntEntry(frm_main, width=4, lower_bound=0, upper_bound=999999)
    ...
    lbl_area1 = Label(frm_main, width=6)
    ...
    lbl_area1.grid(      row=1, column=1, padx=6, pady=3)
