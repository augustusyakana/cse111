...
def count_genders(people_dict):
    ...
    genders_total = len(people_dict)
    female_count = genders_total - num_of_males
    print(f"Male: {num_of_males}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_list in marriages_dict.items():
        ...
        year_wed = marriage_list[WEDDING_YEAR_INDEX]
        
        husbands = people_dict[husband_key]
        husband_name = husbands[NAME_INDEX]
        husband_birth = husbands[BIRTH_YEAR_INDEX]
        husband_age = year_wed - husband_birth
        
        wives = people_dict[wife_key]
        wife_name = wives[NAME_INDEX]
        wife_birth = wives[BIRTH_YEAR_INDEX]
        wife_age = year_wed - wife_birth
        
        print(f"Husband: {husband_name}, Age: {husband_age}, Wife: {wife_name}, Age: {wife_age}, Wedding: {year_wed}, ")
