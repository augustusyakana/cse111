...
def pressure_loss_from_fittings(fluid_velocity, quantity_fittings):
    lost_presure = (-0.04 * 998.2 * fluid_velocity**2 * quantity_fittings) / 2000
    return lost_presure
...
def pressure_loss_from_pipe_reduction(larger_diameter,fluid_velocity, reynolds_number, smaller_diameter):
    const = (0.1 + (50 / reynolds_number)) * ((larger_diameter / smaller_diameter)**4 -1)
    lost_pressure2 = (-const * 998.2 * fluid_velocity**2) / 2000
    return lost_pressure2
