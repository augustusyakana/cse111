    ...
    try:
        ...
        with open(filename, "rt") as text_file:
            ...
            try:
                ...
                if perc_reduc < 0:
                    print(f"{perc_reduc} is a negative number! Please run the"
                            " program again and enter any number from 0 to 100.")
                elif perc_reduc > 100:
                    print(f"{perc_reduc} is too large! Please run the program again"
                            " and use any number from 0 to 100.")
                else:
                    print()
                ...
                print(f"You entered text that is not an integer. Please"
