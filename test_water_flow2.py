from water_flow2 import water_column_height, pressure_gain_from_water_height, pressure_loss_from_pipe, pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction
...
#     assert kpa_to_psi(5) == approx(0.725, abs=0.001)
#     assert kpa_to_psi(2) == approx(0.290, abs=0.001)
#     assert kpa_to_psi(3) == approx(0.435, abs=0.001)
#     assert kpa_to_psi(9.6) == approx(1.392, abs=0.001)
#     assert kpa_to_psi(-5) == approx(-0.725, abs=0.001)   
